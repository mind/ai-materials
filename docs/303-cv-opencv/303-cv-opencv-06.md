...
- CMake软件3.14或更高版本
  ...
  ![2019-06-27 14-37-42屏幕截图](303-cv-opencv-02/2019-06-27 14-37-42屏幕截图.png)

  ![2019-06-27 14-36-46屏幕截图](303-cv-opencv-02/2019-06-27 14-36-46屏幕截图.png)

  ![2019-06-27 14-37-14屏幕截图](303-cv-opencv-02/2019-06-27 14-37-14屏幕截图.png)
...
![2019-06-27 15-07-55屏幕截图](303-cv-opencv-02/2019-06-27 15-07-55屏幕截图.png)

![2019-06-27 15-03-30屏幕截图](303-cv-opencv-02/2019-06-27 15-03-30屏幕截图.png)
...
![2019-06-27 15-21-50屏幕截图](303-cv-opencv-02/2019-06-27 15-21-50屏幕截图.png)

选择对应编译器，cmake会自动检测操作系统内已安装的编译器，这里选择Visual Studio 16 2019，然后点击 ”Finish“ 按钮，开始配置过程。

![2019-06-27 15-26-04屏幕截图](303-cv-opencv-02/2019-06-27 15-26-04屏幕截图.png)

等个将近一分钟就可配置完成，首次配置成功会出现大量红色条目，可以不用去管。

![2019-06-27 15-31-37屏幕截图](303-cv-opencv-02/2019-06-27 15-31-37屏幕截图.png)

在Search框内搜索 ”extra“，在配置选项里找到`OPENCV_EXTRA_MODULES_PATH`，填入`opencv_contrib-3.4.1/modules`的路径。

![2019-06-27 15-36-10屏幕截图](303-cv-opencv-02/2019-06-27 15-36-10屏幕截图.png)

![2019-06-27 16-21-45屏幕截图](303-cv-opencv-02/2019-06-27 16-21-45屏幕截图.png)

接着，在Search框内输入 ”world“ ，在配置选项里找到`BUILD_opencv_world`并勾选。

![2019-06-27 15-42-33屏幕截图](303-cv-opencv-02/2019-06-27 15-42-33屏幕截图.png)
...
![2019-06-27 15-45-13屏幕截图](303-cv-opencv-02/2019-06-27 15-45-13屏幕截图.png)

然后点击Open Project按钮（Generate的右侧），会弹出文件打开选项，这里选择Visual Studio打开项目，如下图：

![2019-06-27 15-51-58屏幕截图](303-cv-opencv-02/2019-06-27 15-51-58屏幕截图.png)
...
![2019-06-27 15-57-21屏幕截图](303-cv-opencv-02/2019-06-27 15-57-21屏幕截图.png)

![2019-06-27 16-00-23屏幕截图](303-cv-opencv-02/2019-06-27 16-00-23屏幕截图.png)

![2019-06-27 16-24-31屏幕截图](303-cv-opencv-02/2019-06-27 16-24-31屏幕截图.png)
